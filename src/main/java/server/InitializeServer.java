...
//            RedisUtil.flushall();
    ...
    private static void clearAllPlayerCache() {
        if (RedisUtil.exists(RedisUtil.KEYNAMES.PLAYER_DATA.getKeyName())) {
            try {
                Map<String, String> datas = RedisUtil.hgetAll(RedisUtil.KEYNAMES.PLAYER_DATA.getKeyName());
                ...
                RedisUtil.del(RedisUtil.KEYNAMES.PLAYER_DATA.getKeyName());
            }
        }
    }
